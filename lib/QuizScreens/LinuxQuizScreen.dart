...
class LinuxQuizScreen extends StatefulWidget {
  const LinuxQuizScreen({super.key});

  @override
  State<LinuxQuizScreen> createState() => _LinuxQuizScreenState();
}

class _LinuxQuizScreenState extends State<LinuxQuizScreen> {
  int seconds = 20;
  Timer? timer;
