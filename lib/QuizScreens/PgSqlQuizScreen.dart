...
class PgSqlQuizScreen extends StatefulWidget {
  const PgSqlQuizScreen({super.key});

  @override
  State<PgSqlQuizScreen> createState() => _PgSqlQuizScreenState();
}

class _PgSqlQuizScreenState extends State<PgSqlQuizScreen> {
  int seconds = 20;
  Timer? timer;
