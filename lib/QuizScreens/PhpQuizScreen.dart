...
import '../API_Details/PhpQuiz.dart';
import '../Constructors/AnswerCard.dart';
import '../resultDetail.dart';

class PhpQuizScreen extends StatefulWidget {
  const PhpQuizScreen({super.key});

  @override
  State<PhpQuizScreen> createState() => _PhpQuizScreenState();
}

class _PhpQuizScreenState extends State<PhpQuizScreen> {
  int seconds = 20;
  Timer? timer;
